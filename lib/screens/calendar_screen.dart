...
// VERSÃO DO CÓDIGO DO VIDEO

/*
import 'dart:collection';

import 'package:demo_table_calendar/models/event_model.dart';
import 'package:demo_table_calendar/utils/faker_api.dart';
      ...
      return Column(
        ...
        children: <Widget>[
          TableCalendar(
            ...
            startingDayOfWeek: StartingDayOfWeek.monday, //Indica que o primeiro dia do calendário é segunda
            pageJumpingEnabled: true, //permite clicar em um dia fora do mês, que ele irá direcionar para o outro mês
         ...
         //Seleciono um novo dia
            onDaySelected: (newSelectedDay, newFocusedDay) {
              setState(() {//aq posso unir as duas
